/*
  # Database Functions for MindBoat Analytics - Fixed Version
  ...
  4. Security
    ...
    - Views use RLS from underlying tables (voyages, destinations)
*/
...
-- The voyage_analytics view will respect RLS policies from voyages and destinations tables