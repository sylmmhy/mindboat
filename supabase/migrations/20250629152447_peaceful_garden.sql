/*
  # High Precision Timing and Enhanced Distraction Types - Safe Migration

  1. Database Schema Changes
    - Add high precision timing columns to voyages table
    - Safely handle existing distraction event types
    - Add functions for precise duration calculations

  2. Enhanced Features
    - Millisecond precision for voyage durations
    - Better statistics calculation with precise timing
    - Enhanced assessment data with precision metrics

  3. Safety Measures
    - No destructive constraint changes
    - Backward compatibility with existing data
    - Graceful handling of missing precision data
*/
